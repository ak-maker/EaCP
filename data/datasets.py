...
_base = str(Path(__file__).resolve().parent.parent / 'datasets')
data_dirs = {'IN1k': f'{_base}/imagenet/val/',
             'INv2': f'{_base}/imagenetv2/imagenetv2-matched-frequency-format-val/',
             'INa': f'{_base}/imagenet-a/',
             'INr': f'{_base}/imagenet-r/',
             'INc': f'{_base}/imagenet-c/'}
